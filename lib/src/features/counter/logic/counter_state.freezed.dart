...
class _$CounterStateTearOff {
  ...
  _Data data({required int number}) {
    return _Data(
      number: number,
    );
  }
...
/// @nodoc
class __$DataCopyWithImpl<$Res> extends _$CounterStateCopyWithImpl<$Res>
...
class _$_Data implements _Data {
  const _$_Data({required this.number});
  ...
  @override
  String toString() {
    return 'CounterState.data(number: $number)';
  }
...
abstract class _Data implements CounterState {
  const factory _Data({required int number}) = _$_Data;
...
class _$_Error implements _Error {
  ...
  @override
  String toString() {
    return 'CounterState.error(errorMessage: $errorMessage)';
  }
